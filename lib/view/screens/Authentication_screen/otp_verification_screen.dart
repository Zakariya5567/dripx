                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            20.height,
                            controller.isOtpVerification ? const Center(child: CircularProgressIndicator(color: whitePrimary,),) :  CustomButton(
                              buttonName: btnVerifyAndProceed,
                              onPressed: () async {

                                if (formKey.currentState!.validate()) {
                                  FocusManager.instance.primaryFocus?.unfocus();
                                  controller.otpVerification(context, email);
                                }
                              },
                            ),
                            30.height,
                            Row(
                              ...
                              children: [
                                ...
                                textBtnResendCode
                                    ...
                                    .onPress(() async {
                                  if(start == 0) {
                                    await controller.resetPassword(context, email, false);
                                    start = 60;
                                    startTimer(controller);
                                  }
                                })
